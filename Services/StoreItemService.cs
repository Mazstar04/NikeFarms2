    ...
    public class StoreItemService : IStoreItemService
    {
        ...
        public StoreItem Add(StoreItemDTO storeItemDTO)
        {
            ...
            Notification notify = new Notification
            {
                ...
                $" Qty: {Comma((decimal)storeItemDTO.NoOfItem)} ,  Item Per Kg: {storeItemDTO.ItemPerKg} Kg , Price Purchased: N{Comma(storeItemDTO.TotalPricePurchased)}",
        ...
        {
            var numberWithComma = string.Format(CultureInfo.InvariantCulture, "{0:#,###,##}", number);
