...
namespace NikeFarms.v2._0.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            return _dbContext.Users.Where(u=> u.Id != 1 && u.Id != userId).OrderByDescending(r => r.IsActive).ToList();
        }

        public List<User> GetActiveUsers(int userId)
        {
            return _dbContext.Users.Where(u => u.Id != 1 && u.Id != userId && u.IsActive==true).OrderByDescending(r => r.CreatedAt).ToList();
        }
